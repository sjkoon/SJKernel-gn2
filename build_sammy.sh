...
export KBUILD_BUILD_VERSION="SJK"
...
mv $KERNEL_PATH/releasetools/tar/$1.tar /home/sjkoon/sjkoon/sjkoon/public_html/kernel/$1/sjkernel_$2_$1.tar
mv $KERNEL_PATH/releasetools/zip/$1.zip /home/sjkoon/sjkoon/sjkoon/public_html/kernel/$1/sjkernel_$2_$1.zip
